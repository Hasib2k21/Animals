...
List<Owner> owners = [
  Owner(
    name: 'Sophia',
    image: 'pets-image/woman-with-cat1.png',
  ),
  Owner(
    name: 'Annie',
    image: 'pets-image//woman-with-cat2.png',
  ),
  Owner(
    name: 'Jessica',
    image: 'pets-image/woman-with-cat3.png',
  ),
];
